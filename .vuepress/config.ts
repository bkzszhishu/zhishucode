...
const author = "程序员止束";
const domain = "http://zhishucode.icu";
const tags = ["程序员", "编程", "计算机", "Java", "后端开发"];


export default defineConfig({
  title: "止束的学习笔记",
  description: "从0到1的Java后端开发笔记",
  dest: ".vuepress/dist",
  head: [
    // 站点图标
    ...
    [
      "meta",
      {
        name: "keywords",
        content:
          "程序员止束, Java后端开发, 编程知识百科, 后端, 微服务, 中间件, 开发, 项目, IT",
      },
    ],
    // 百度统计
    [
      ...
      `
            ...
            (function() {
              ...
              hm.src = "https://hm.baidu.com/hm.js?840dfa3f74fffcb17e91e6f2edbf24ca";
